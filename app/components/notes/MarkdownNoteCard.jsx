...
import { Pin, PinOff, Pencil, Trash2, X, FileText, Maximize2, Check } from "lucide-react";
...
function MarkdownNoteCard({ note, currentUser, users, onUpdate, onDelete, lang, categories }) {
            ...
            >
                ...
                <div className="p-4 flex flex-col gap-3 flex-1">
                    ...
                    {editing ? (
                        ...
                        <div className="prose prose-sm max-w-none line-clamp-[8] overflow-hidden">
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b bg-muted/5">
                            ...
                            <div className="flex items-center gap-2">
                                {editing ? (
                                    ...
                                    >
                                        <Pencil className="w-4 h-4" /> {lang === "id" ? "Edit Catatan" : "Edit Note"}
                                    </button>
                                )}
                                <button
